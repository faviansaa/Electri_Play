 ...
 * @author saafa
 */
public class Introducion extends javax.swing.JFrame {

    /**
     * Creates new form Introducion
     */
    public Introducion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(13, 144, 204));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/robot 1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Introducion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new Introducion().setVisible(true);
            }
        });
    }
